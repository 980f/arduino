...
{
	uint32_t moreoptions= baudrate & 0x1F; //980F: pack 5 option bits into lsbs of baudrate. All standard baudrates have that many zero lsbs
	baudrate&=~0x1F;
  ...
  | (moreoptions&7)<<28 //980f:  LOWTOUT and INACTTOUT, prevent bus hangs on most defective wiring and some defective slaves
  | (moreoptions&(3<<3))<<(24-3) //980f: FM+ or High speed enable: bits 25..24 set from options 4..3, 
  ;
