...
//std::conditional was missing on one platform, and was getting tedious to figure out how to add this.
...
/** provides type at least large enough for the given bits.
   This should be somewhere in the c++ std library but I haven't found it
 * */
