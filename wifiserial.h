...
/* use wifi like a stream (should rename class) */

//todo: somehow communicate with other wifi modules at compile time, until then any wifi use is exclusive of all others
...
#include "millievent.h"  //for connection retry rate (to AP)
